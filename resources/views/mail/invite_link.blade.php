...
<head>
	...
	<style type="text/css">
		@media (max-width: 480px) {
			...
			.t11 {
				mso-line-height-alt: 18px !important;
	...
	<!--[if !mso]>-->
	<link
		href="https://fonts.googleapis.com/css2?family=Fira+Sans:wght@400;600;700&amp;family=Montserrat:wght@800&amp;display=swap"
...
<body id=body class=t40 style="min-width:100%;Margin:0px;padding:0px;background-color:#EDEDED;">
	<div class=t39 style="background-color:#EDEDED;">
		<table role=presentation width=100% cellpadding=0 cellspacing=0 border=0 align=center>
			<tr>
				<td class=t38 style="font-size:0;line-height:0;mso-line-height-rule:exactly;background-color:#EDEDED;"
						...
						<tr>
							<td align=center>
								<table class=t22 role=presentation cellpadding=0 cellspacing=0
									...
									<tr>
										<!--[if mso]>
<td width=680 class=t21 style="background-color:#FFFFFF;padding:60px 30px 100px 30px;">
<![endif]-->
										<!--[if !mso]>-->
										<td class=t21
											style="background-color:#FFFFFF;width:620px;padding:60px 30px 100px 30px;">
											<!--<![endif]-->
...
<![endif]-->
																						...
																						<td class=t1
																							...
																							<div style="font-size:0px;">
																								<img class=t0
																									...
																									height=39.34375
																									alt=""
																									src="https://be04718c-945e-4728-8c5b-52b51bed08de.b-cdn.net/e/b4ae2650-37c9-43e7-aace-576d4ca7277b/4e1ca3fa-0e5f-4706-90ee-5203a36fb45d.png" />
																							</div>
																						</td>
																					</tr>
																				</table>
																		...
																		<tr>
																			<td>
																				<div class=t3
																					style="mso-line-height-rule:exactly;mso-line-height-alt:90px;line-height:90px;font-size:1px;display:block;">
																					&nbsp;&nbsp;</div>
																			</td>
																		</tr>
																		<tr>
...
<![endif]-->
																						<!--[if !mso]>-->
																						<td class=t5
																							style="border-bottom:1px solid #E1E2E6;width:475px;padding:0 0 40px 0;">
																							<!--<![endif]-->
																							<h1 class=t4
																								...
																								{{ucwords(Auth::user()->first_name)}} {{ucwords(Auth::user()->last_name)}} invited you</h1>
																						</td>
																					</tr>
																				</table>
																			</td>
...
<![endif]-->
																						...
																						<td class=t9
																							...
																							<p class=t8
																								...
																								You are receiving this email because you have been granted access to open the door. Please use the button below to unlock the door.</p>
																						</td>
																					</tr>
																				</table>
																			</td>
...
<![endif]-->
																						...
																						< class=t13
																							...
																							<p class=t12
																								style="margin:0;Margin:0;font-family:Fira Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:28px;font-weight:400;font-style:normal;font-size:18px;text-decoration:none;text-transform:none;direction:ltr;color:#9095A2;text-align:left;mso-line-height-rule:exactly;mso-text-raise:3px;">
																								This link is unique to you and can be used to open the door.</p>
																								<p>This Link is valid from: {{$inviteLink->valid_from}}</p>
																								<p>bis until: {{$inviteLink->expires_at}}</p>
						...
						<tr>
							<td align=center>
								<table class=t37 role=presentation cellpadding=0 cellspacing=0
									...
									<tr>
										<!--[if mso]>
<td width=680 class=t36 style="background-color:#000000;padding:80px 30px 80px 30px;">
<![endif]-->
										<!--[if !mso]>-->
										<td class=t36
											style="background-color:#000000;width:620px;padding:80px 30px 80px 30px;">
											<!--<![endif]-->
											<table role=presentation width=100% cellpadding=0 cellspacing=0
												style="width:100% !important;">
												<tr>
													<td align=center>
														<table class=t35 role=presentation cellpadding=0 cellspacing=0
															style="Margin-left:auto;Margin-right:auto;">
															<tr>
																<!--[if mso]>
<td width=475 class=t34 style="background-color:transparent;">
<![endif]-->
																<!--[if !mso]>-->
																<td class=t34
																	style="background-color:transparent;width:475px;">
																		...
																		<tr>
																			<td align=center>
																				<table class=t25 role=presentation
																					...
																					<tr>
																						<!--[if mso]>
<td width=475 class=t24 style="border-bottom:1px solid #262626;padding:0 0 60px 0;">
<![endif]-->
																						<!--[if !mso]>-->
																						<td class=t24
																							style="border-bottom:1px solid #262626;width:475px;padding:0 0 60px 0;">
																							<!--<![endif]-->
																							<h1 class=t23
																								style="margin:0;Margin:0;font-family:Fira Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:32px;font-weight:600;font-style:normal;font-size:32px;text-decoration:none;text-transform:none;direction:ltr;color:#FFFFFF;text-align:left;mso-line-height-rule:exactly;">
																								Smart Door</h1>
																						</td>
																					</tr>
																				</table>
																		...
																		<tr>
																			<td align=center>
																				<table class=t29 role=presentation
																					cellpadding=0 cellspacing=0
																					style="Margin-left:auto;Margin-right:auto;">
																					<tr>
																						<!--[if mso]>
<td width=475 class=t28>
<![endif]-->
																						<!--[if !mso]>-->
																						<td class=t28
																							style="width:475px;">
