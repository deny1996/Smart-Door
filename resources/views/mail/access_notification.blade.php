...
<![endif]-->
																						...
																						<td class=t5
																							...
																							<h1 class=t4
																								...
																								Door Unlocked by {{ucwords($guest_name->name)}}</h1>
																						</td>
																					</tr>
																				</table>
																			</td>
...
<![endif]-->
																						...
																						<td class=t9
																							...
																							<p class=t8
																								...
																								Hello {{ucwords($user_name->first_name)}},<br/>
                                                                                                We wanted to inform you that {{ucwords($guest_name->name)}} has successfully unlocked the door
                                                                                                on {{ date('d.m.Y') }} at {{ now()->setTimezone('Europe/Berlin')->format('H:i') }}. <br/><br/>
                                                                                                If this action wasn't expected or authorized, please contact support immediately.<br/><br/>
