...
<![endif]-->
																						...
																						<td class=t9
																							...
																							<p class=t8
																								...
																								Please use the following two-factor code to unlock the door.<br/>
                                                                                                This additional step enhances security<br/><br/>
                                                                                                Two-Factor Code: <strong>{{ $twoFactorAuth }}</strong> <br/> <br/>
                                                                                                Thank you!</p>
																						</td>
																					</tr>
																				</table>
